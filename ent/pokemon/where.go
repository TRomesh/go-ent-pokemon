...
func HasContender() predicate.Pokemon {
	return predicate.Pokemon(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(ContenderTable, FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, ContenderTable, ContenderColumn),
		)
...
func HasContenderWith(preds ...predicate.Battle) predicate.Pokemon {
	return predicate.Pokemon(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
// HasOpponent applies the HasEdge predicate on the "opponent" edge.
func HasOpponent() predicate.Pokemon {
	return predicate.Pokemon(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(OpponentTable, FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, OpponentTable, OpponentColumn),
		)
		sqlgraph.HasNeighbors(s, step)
	})
}

// HasOpponentWith applies the HasEdge predicate on the "opponent" edge with a given conditions (other predicates).
func HasOpponentWith(preds ...predicate.Battle) predicate.Pokemon {
	return predicate.Pokemon(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(OpponentInverseTable, FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, OpponentTable, OpponentColumn),
		)
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
